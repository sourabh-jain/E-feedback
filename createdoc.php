...
echo '<html>
		...
		<br>
		<div style="font-size:30px">'  .$sheader . '</div>
		<br>
		<body>
		...
		{
			echo '<td style="align:center;color:white;width:150px;height:30px;background-color:#3F49CC"><b>' . $headercols . '</td></center>';
		}
		...
		foreach($data as $rows)
		{
			...
			{
				if($cols!='')
					echo '<td style="align:center">' . $cols . '</td>';
			}
			echo '</tr>';
		}
		echo '
