...
$LOWER_RANGE = 0;  /* Upper range of rows to view */
                ...
                <section class="content">
				 ...
				 <div class="small-box bg-green">
                                ...
                                <div class="icon">
									...
									?>
                                <a href="#" onclick="$('<?php echo $filen;?>').toggle(1000)" class="small-box-footer">
                                    Click here <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
				</div>
...
-->
				 ...
				 <div class="small-box bg-blue">
                                ...
                                <a href="quickanalysis.php" class="small-box-footer">
                                    Click here <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
						</div>
				...
				<div class="small-box bg-maroon">
                                ...
                                <a href="fullresult.php" class="small-box-footer">
                                    Click here <i class="fa fa-arrow-circle-right"></i>
                                </a>
                </div>		
				</div>
...
*/
					...
					echo '<BR><BR>';
					echo '<div class="alert alert-success">CURRENT RESULTS : Viewing <font color="red">' . ($UPPER_RANGE -$LOWER_RANGE +1). '</font> rows of users';
					echo ' who have ';
					echo '<font color="red">';
					if($STATUS1!=$STATUS2)
